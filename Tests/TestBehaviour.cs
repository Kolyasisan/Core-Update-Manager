...
{
    public float GameplayUpdateValue;
    public float GameplayUpdateRand;
    ...
    public override void CoreInitSetup()
    {
        ...
        UM_SETTINGS_GAMEPLAYUPDATE = new LoopUpdateSettings(default);
    ...
    {
        GameplayUpdateRand = Random.Range(5f, 10f);
    ...
    {
        GameplayUpdateValue = Mathf.Repeat(GameplayUpdateValue + GameplayUpdateRand * Time.deltaTime, 4096f);
    }
